...
<body>
	...
	<div class="mypage" style="margin-top:10%;">
		<div class="container sidebar">
			<h2>마이페이지</h2>
			<hr class="hrclass">
			<br><br><br>
			<ul class="firstMenu">
				<li><a class="page-scroll" href="#table"><strong>작성글 보기  </strong><span><img src="img/file.png"></span></a><br>
					<hr>
				</li>
			</ul>
			<ul class="secondMenu">
				<li><a href="changeInfo.jsp" class="sidefont"><strong>개인정보 변경  </strong><span><img src="img/pencil.png" width="16px;"></span><!-- <img
							src="img/btn_lnb_expand.gif" class="imgg"> --></span></a> <br>
					<hr></li>
			</ul>
			<ul class="lastMenu">
				<li><a href="changePW.jsp" class="sidefont"><strong>비밀번호 변경  <strong><span><img src="img/pencil.png" width="16px;"></span><!-- img
					...
					<div class="tblArticle">
						<form id="fmMultiProcess" name="fmMultiProcess" method="POST"
							...
							<table class="table table-striped"
								...
								<thead >
									<tr>
										<th style="background-color: #ffdd00; text-align: center;">번호</th>
										<th style="background-color: #ffdd00; text-align: center;">제목</th>
										<th style="background-color: #ffdd00; text-align: center;">작성자</th>
										<th style="background-color: #ffdd00; text-align: center;">작성일</th>
										<th style="background-color: #ffdd00; text-align: center;">조회</th>
									</tr>
								</thead>
								<tbody>
									<%
